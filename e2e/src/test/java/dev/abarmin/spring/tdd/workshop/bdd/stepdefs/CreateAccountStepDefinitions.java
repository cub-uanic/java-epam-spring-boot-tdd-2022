...
public class CreateAccountStepDefinitions {
    ...
    public void andApplicantWantsToGetInformationAboutAccount() {
        ...
        lastResponse = applicantService
                .findApplicantByEmail(applicant
                        .getContactPoint()
    ...
    public void responseShouldContainEmail(final String email) {
        final Applicant applicant = (Applicant) lastResponse.getBody();
        assertThat(applicant)
                .withFailMessage("Applicant is NULL")
                .isNotNull();

        final String retrievedEmail = applicant
                .getContactPoint()
                .getElectronicAddress()
                .getEmail();
